                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="nivel" id="" class="form-control">
                                                <option value="VIRTUAL"<?php if($nivel=='VIRTUAL'){ ?> selected="selected" <?php } ?>>VIRTUAL</option>
                                                <option value="PRESENCIAL"<?php if($nivel=='PRESENCIAL'){ ?> selected="selected" <?php } ?>>PRESENCIAL</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
